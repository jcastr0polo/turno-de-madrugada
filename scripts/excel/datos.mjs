...
export const presupuesto = [
  ...
  { tipo: 'OPEX', categoria: 'Tramites', concepto: 'Impresiones y radicacion de derechos de peticion', cantidad: 1, unidad: 'global', valor: 25000, nota: 'Solicitud a Bienestar Universitario' },
...
export const cronograma = [
  ...
  { fase: 'Preproduccion intelectual', tarea: 'Redaccion y radicacion del derecho de peticion', nodo: 'Ambos', inicio: '2026-09-05', fin: '2026-09-07' },
